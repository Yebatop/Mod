...
public final class BuyerScanner {
    ...
    /**
     * Читает то окно, которое открыто прямо сейчас. Ничего не кэширует между вызовами:
     * ассортимент и остатки меняются, а показывать вчерашние числа хуже, чем никакие.
     */
