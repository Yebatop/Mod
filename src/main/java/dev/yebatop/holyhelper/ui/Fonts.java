...
public final class Fonts {
     ...
     * тринадцать: клиент размещает его глифы по своей мере, а не по той, что
     * лежит в шрифте. Поэтому здесь стоит замеренное, а не вычисленное, и менять
     * его можно только новым замером.
     * <p>
     * Первый замер дал десять и был неверен: я читал положение букв с мелкого
     * снимка на глаз и промахнулся на три пикселя. Второй снимок, где цифра уже
     * стояла ниже, дал разницу точнее — на большем расстоянии ошибка чтения
     * весит меньше.
     * <p>
     ...
     */
    public static final int BASELINE_DISPLAY = 13;
